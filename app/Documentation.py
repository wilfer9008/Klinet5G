...
st.markdown("This application allows you to upload and visualize raw data from various sources:")
...
info_path = st.text_input("Enter the **absolute** path to the `info.json` file from your dataset:")
...
st.markdown("Navigate through the sidebar menu to the corresponding data source to view the plots.")
